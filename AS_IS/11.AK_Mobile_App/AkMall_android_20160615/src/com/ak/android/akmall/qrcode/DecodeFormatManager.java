...
final class DecodeFormatManager {
  ...
  static Collection<BarcodeFormat> parseDecodeFormats(Intent intent) {
    ...
    String scanFormatsString = intent.getStringExtra(ZxingIntents.Scan.FORMATS);
  ...
  private static Collection<BarcodeFormat> parseDecodeFormats(Iterable<String> scanFormats,
    ...
    if (decodeMode != null) {
      if (ZxingIntents.Scan.PRODUCT_MODE.equals(decodeMode)) {
        return PRODUCT_FORMATS;
      }
      if (ZxingIntents.Scan.QR_CODE_MODE.equals(decodeMode)) {
        return QR_CODE_FORMATS;
      }
      if (ZxingIntents.Scan.DATA_MATRIX_MODE.equals(decodeMode)) {
        return DATA_MATRIX_FORMATS;
      }
      if (ZxingIntents.Scan.ONE_D_MODE.equals(decodeMode)) {
