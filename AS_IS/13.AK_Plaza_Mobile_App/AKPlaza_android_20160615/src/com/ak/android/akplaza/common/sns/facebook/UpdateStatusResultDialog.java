    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPostButton.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View v) {
            	 ...
            	 */
        		FaceBookUtility.mAsyncRunner.request(postId, new WallPostRequestListener());
        	}
        });
		mDeletePostButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	 ...
            	 */
            	FaceBookUtility.mAsyncRunner.request(postId, new Bundle(), "DELETE", new WallPostDeleteListener(), null);
            }
        });
    }
