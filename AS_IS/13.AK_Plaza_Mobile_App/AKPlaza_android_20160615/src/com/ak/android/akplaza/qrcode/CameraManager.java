...
public final class CameraManager {
  ...
  public Rect getFramingRect() {
    if (framingRect == null) {
      ...
      final int side = (screenResolution.x < screenResolution.y ? screenResolution.x : screenResolution.y) * 3 / 4;

      int width = screenResolution.y;
      /*int width = side;
      ...
      int leftOffset = 0;//(screenResolution.y - width) / 2;
