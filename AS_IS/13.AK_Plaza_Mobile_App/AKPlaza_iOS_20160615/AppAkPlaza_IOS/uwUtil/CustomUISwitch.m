...
#define SWITCH_DISPLAY_WIDTH		94.0    //switch width
#define SWITCH_WIDTH				124.0   //ON,OFF width
...
#define RECT_FOR_HALFWAY	CGRectMake(-28.5, 0.0, SWITCH_WIDTH, SWITCH_HEIGHT)
...
- (void)setupUserInterface
{
	...
	bg.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"switch_on.png" ofType:nil]];
	...
	foreground.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"switch.png" ofType:nil]];  
...
- (void)setOn:(BOOL)on animated:(BOOL)animated
{
	...
	if (_on)
	{
		...
		self.backgroundImage.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"switch_on.png" ofType:nil]];  
        
	}
	else
	{
		self.switchImage.frame = RECT_FOR_OFF;
		self.backgroundImage.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"switch_off.png" ofType:nil]];  
